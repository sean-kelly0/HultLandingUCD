...
const EVENTBRITE_URL = 'https://www.eventbrite.com/e/hult-prize-irish-national-competition-tickets-1984974510194?utm-campaign=social&utm-content=attendeeshare&utm-medium=discovery&utm-term=listing&utm-source=cp&aff=ebdsshcopyurl'
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="mt-5 text-white/60 leading-relaxed font-light">
              Open to students from all Irish universities. Whether you're pitching a bold idea or
            ...
            <div className="mt-10 space-y-5">
              ...
              <ContactItem icon={instagramIcon} label="Instagram">
                <a href="https://www.instagram.com/hultprizeucd" className="text-sky hover:underline text-sm">@hultprizeucd</a>
              </ContactItem>
            </div>
          </div>

          {/* Right: Eventbrite CTA */}
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 flex flex-col items-center text-center">
            ...
            <p className="text-white/50 font-light mb-8">
              April 2026 · University College Dublin<br />Register now on Eventbrite to secure your place.
            </p>
            <a
              href={EVENTBRITE_URL}
              target="_blank"
